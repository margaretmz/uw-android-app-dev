...
public class AndroidContract {
    ...
    public static final String CONTENT_AUTHORITY = "edu.uw.aad.mzm.sample.provider";
    ...
    public static final class Version implements BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/edu.uw.aad.mzm.sample.provider.versions";
        // Use MIME type prefix android.cursor.item/ for returning a single item
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/edu.uw.aad.mzm.sample.provider.version";
